...
const AlterServiceOrder = () => {
  ...
  const onSubmit = () => {
    ...
    reuseServiceOrderMutation.mutate(
      {
        id: serviceOrder.id,
        file: data.file,
    ...
    <DefaultPageContainer>
      <FormProvider {...methods}>
        ...
        <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-4">
          {step === StepKeys.Step1 && <FirstStep isAlteration={true} />}
          {step === StepKeys.Step2ClicheCorrugated && (
            <SecondStep isAlteration={true} />
          )}
          {step === StepKeys.Step2DieCutBlock && (
            <SecondStepDieCutBlock isAlteration={true} />
          )}
          ...
          <StepButtons
            ...
            methods={methods}
            submitText="Alterar ordem de serviço"
          />
        </form>
      </FormProvider>
    </DefaultPageContainer>
...
export default AlterServiceOrder;
