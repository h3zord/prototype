...
const DieCutBlockReplacementPDF: React.FC<DieCutBlockPDFProps> = ({
  onClose,
      ...
      z-index: 2 !important;
        ...
        >
          <div className="w-full border-[2px] border-black bg-white p-2">
            ...
            <h2 className="text-lg text-center lg:text-left mt-2">Montagem</h2>
...
export default DieCutBlockReplacementPDF;
