...
const ClicheCorrugatedRepairPDF: React.FC<ClicheCorrugatedPDFProps> = ({
  onClose,
  ...
  const renovationRepair = so.renovationRepair
    ?.map((repair: string) => repair)
    .join(", ");
  const itemCustomer = so.itemCodeOnCustomer;
  const repairColorsQuantity = so?.printerDetails?.quantityColorsToRepair;
      ...
      z-index: 2 !important;
        ...
        >
          <div className="w-full border-[2px] border-black bg-white p-2">
            ...
            <h2 className="text-lg text-center lg:text-left mt-6">
              Dados de Serviço
            </h2>
            ...
            <div className="bg-neutral-50 p-1 rounded-xl mb-6">
              <div className="flex items-center gap-2">
                <div className="flex-1">
                  <InfoField
                    label="Tipo do conserto:"
                    value={renovationRepair}
                  />
                </div>
            ...
            {hasPermission(PermissionType.VIEW_PCP_PRICES) && (
              <div className="bg-neutral-100 px-3 p-2 text-sm w-fit ml-auto rounded">
                <div className="flex gap-1">
                  <>
                    ...
                    <span>
                      {formatPrice({ price: displayPrice || 0, digits: 2 })}
                    </span>
                  </>
                </div>
              </div>
...
export default ClicheCorrugatedRepairPDF;
