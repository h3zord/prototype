...
const DecimalInputFixed = ({
  ...
  // Removido o uso de withHookFormMask.
    ...
    <div className="flex flex-col relative justify-center">
      ...
      <div className={`relative w-full ${disabled ? "bg-white/10" : ""}`}>
        <input
          ...
          className={`bg-transparent outline-none border placeholder-gray-500 p-2 rounded h-10 ${className} ${
            disabled
...
export default DecimalInputFixed;
